# Redis 4.0.10 → Valkey 8.1 迁移 - 手动测试步骤
...
echo "Valkey 8.1 的值: $(docker exec redis-green redis-cli GET "$TEST_KEY")"
...
echo "Valkey 8.1: $GREEN_COUNT 个键"
...
- [ ] 步骤 1: Redis 4.0 和 Valkey 8.1 都能 PING 通 ✅
- [ ] 步骤 2: Redis 4.0 有 1500+ 个键 ✅
- [ ] 步骤 3: redis-shake 启动成功，日志显示 `syncing aof` ✅
- [ ] 步骤 4: Valkey 8.1 键数量和 4.0 一致 ✅
